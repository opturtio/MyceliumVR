...
//        [Range (0, .5f)]
        ...
        void CreateRoadMesh () {
            ...
            for (int i = 0; i < path.NumPoints; i++) {
                ...
                Vector3 vertSideA = path.GetPoint (i) - localRight * Mathf.Abs (roadWidth) + localUp * 0.5f * thickness;
                Vector3 vertSideB = path.GetPoint (i) + localRight * Mathf.Abs (roadWidth) + localUp * 0.5f * thickness;
